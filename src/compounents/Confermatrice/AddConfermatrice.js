...
const openNotification = () => {
    ...
    notification.open({
        message: 'Bon travail',
        description:
            "La Confermatrice a été ajouté.",
        btn,
        key,
        onClose: close,
    });
};
class AddConfermatrice extends Component {
    constructor() {
        super()
        this.state = {
            first_name: "",
    ...
    onSubmit(e) {
        ...
        axios({
            url: "http://151.80.56.201:5000/Dashboard/AddConfermatrice",
            method: 'POST',
            data: formData,
            headers: {
                'Content-Type': 'application/json',
                ...
                <Layout className="site-layout">
                    ...
                    <Content style={{ margin: '0 16px' }}>
                        <Breadcrumb style={{ margin: '16px 0' }}>
                            ...
                            <Breadcrumb.Item>Ajouter une Confermatrice</Breadcrumb.Item>
                        </Breadcrumb>
...
export default AddConfermatrice