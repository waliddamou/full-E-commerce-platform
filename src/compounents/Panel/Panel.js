...
import { Row, Col, Layout, Menu, Typography, Breadcrumb, Divider } from 'antd';
import '../../App.css';
import {MoneyCollectOutlined,PhoneOutlined, WarningTwoTone,StarOutlined ,DollarCircleOutlined, MenuOutlined, LogoutOutlined, ToolOutlined, ShoppingCartOutlined, UsergroupAddOutlined, MoreOutlined, ShoppingOutlined, MenuUnfoldOutlined, DashboardOutlined, EditOutlined, ChromeOutlined, PlusCircleOutlined } from '@ant-design/icons';
...
class Panel extends Component {
    ...
    componentDidMount() {
        ...
        let result = []
        fetch('http://151.80.56.201:5000/Dashboard', {
            method: 'get', headers: {
                Accept: 'application/json',
                'Content-Type': 'application/json',
            ...
            .then((findresponse) => {
                this.setState({
                    products: findresponse.lessProducts
                })
            })
                ...
                <Layout className="site-layout">
                    ...
                    <Content style={{ margin: '0 16px' }}>
                        ...
                        <div className="site-layout-background center" style={{ padding: 24, minHeight: 360 }}>
                            <Text style={{ color: "#f88c00" }}><b>Alerte ! ces produits seront en rupture de stock</b> </Text>
                            <br />
                            <div className="row">
                                {this.state.products !== [] ?
                                    this.state.products.map((item) =>
                                        ...
                                        <BrowserView>
                                            <Row>
                                                ...
                                                <img src={`http://151.80.56.201:5000/static/products/${item.Photo}`} alt="Productimage" style={{ height: "100px", width: "100px" }} />
                                                </Col>
                                                ...
                                                <Text style={{ fontFamily: "bold", color: "red" }}>
                                                        <b>{item["Details"].Taille}</b>
                                                </Text>
                                                </Col>
                                                <Col className="gutter-row" span={4}>
                                                <Text style={{ fontFamily: "bold", color: "red" }}>
                                                        <b>{item["Details"].Quantité}</b>
                                                </Text>
                                                </Col>
                                                <Col className="gutter-row" span={4}>
                                                <WarningTwoTone twoToneColor="red" style={{ fontSize: "30px" }} />
                                                </Col> 
                                            </Row>
                                            </BrowserView>
                                            <MobileView>
