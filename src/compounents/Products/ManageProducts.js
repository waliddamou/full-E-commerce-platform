...
class ManageProducts extends Component {
    ...
    componentDidMount() {
        ...
        const result=[]
        fetch('http://151.80.56.201:5000/Dashboard/ManageProducts', {
            method: 'get', headers: {
                Accept: 'application/json',
                'Content-Type': 'application/json',
        ...
        {   this.setState({
            ...
            result.push([row.id, row.Name,row.Type,row.Subcategory,row.Mother,<><Link to={"/EditProduct/"+row.id} ><EditOutlined /></Link> <Button onClick={()=>this.DeleteProduct(row.id)} icon={<DeleteOutlined />}></Button></>])) })   
        } )
    ...
    DeleteProduct = (id)=>{
        ...
        axios({
            url: "http://151.80.56.201:5000/Dashboard/ManageProducts",
            method: 'POST',
            data: formData,
            headers: {
                ...
                <Layout className="site-layout">
                    ...
                    <Content style={{ margin: '0 16px' }}>
                        <Breadcrumb style={{ margin: '16px 0' }}>
                            ...
                            <Breadcrumb.Item>Gérer les Types</Breadcrumb.Item>
                        </Breadcrumb>
