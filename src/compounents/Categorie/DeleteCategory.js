...
class DeleteCategory extends Component {
    ...
    onSubmit(e) {
        ...
        axios({
            url: "http://151.80.56.201:5000/Dashboard/DeleteCategories/"+id,
            method: 'POST',
            data: formData,
            headers: {
            ...
            this.props.history.push('/ManageCategories')
        })
    ...
    componentWillMount(){
        ...
        fetch('http://151.80.56.201:5000/Dashboard/panel',{method: 'get', headers:{
        ...
        fetch('http://151.80.56.201:5000/Dashboard/EditCategories/'+id,{method: 'get', headers:{
            Accept: 'application/json',
                     'Content-Type': 'application/json',
                     'Authorization': "Bearer " + token,
             }})
                ...
                <Layout className="site-layout">
                    ...
                    <Content style={{ margin: '0 16px' }}>
                        <Breadcrumb style={{ margin: '16px 0' }}>
                            ...
                            <Breadcrumb.Item>supprimer une Catégorie</Breadcrumb.Item>
                        </Breadcrumb>
                        <div className="site-layout-background" style={{ padding: 24, minHeight: 360 }}>
                            <div className="col s12 m6">
                                ...
                                <form noValidate onSubmit={this.onSubmit}>
                                    ...
                                    <button onClick={openNotification} type="submit" className="btn red align-center" style={{ background: "#9f53af" }}>{<DeleteOutlined spin />} Supprimer</button>
