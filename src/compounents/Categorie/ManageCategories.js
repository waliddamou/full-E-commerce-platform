...
class ManageCategories extends Component {
            ...
            .then((findresponse) => {
                    ...
                    this.setState({
                        Categories: findresponse.Categories.map((row, i) =>
                            result.push([row.id, row.Name, <><Link to={"/EditCategorie/" + row.id} ><EditOutlined /></Link> <Button onClick={() => this.DeleteCategory(row.id)} icon={<DeleteOutlined />}></Button></>]))
                    })
    ...
    DeleteCategory = (id) => {
        ...
        axios({
            url: "http://151.80.56.201:5000/Dashboard/ManageCategories",
            method: 'POST',
            data: formData,
            headers: {
                ...
                <Layout className="site-layout">
                    ...
                    <Content style={{ margin: '0 16px' }}>
                        <Breadcrumb style={{ margin: '16px 0' }}>
                            ...
                            <Breadcrumb.Item>Gérer les Catégories</Breadcrumb.Item>
                        </Breadcrumb>
                        <div className="site-layout-background" style={{ padding: 24, minHeight: 360 }}>
                            <MUIDataTable
                                title={"Catégories"}
                                columns={["ID", "NOM", "Actions"]}
