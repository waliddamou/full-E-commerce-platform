...
class EditCategory extends Component {
    ...
    componentDidMount() {
        ...
        fetch(`http://151.80.56.201:5000/Dashboard/EditCategories/${this.state.id}`, {
            method: 'get', headers: {
                Accept: 'application/json',
                'Content-Type': 'application/json',
    ...
    onSubmit(e) {
        ...
        axios({
            url: `http://151.80.56.201:5000/Dashboard/EditCategories/${this.state.id}`,
            method: 'POST',
            data: formData,
            headers: {
            ...
            this.setState({name : response.data.Categories_list[0].Name})
        })
                ...
                <Layout className="site-layout">
                    ...
                    <Content style={{ margin: '0 16px' }}>
                        <Breadcrumb style={{ margin: '16px 0' }}>
                            ...
                            <Breadcrumb.Item>Modifier la Catégorie</Breadcrumb.Item>
                        </Breadcrumb>
