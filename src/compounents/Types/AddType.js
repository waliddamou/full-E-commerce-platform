...
class AddType extends Component {
    ...
    onSubmit(e) {
        ...
        axios({
            url: "http://151.80.56.201:5000/Dashboard/AddType",
            method: 'POST',
            data: formData,
            headers: {
                ...
                <Layout className="site-layout">
                    ...
                    <Content style={{ margin: '0 16px' }}>
                        <Breadcrumb style={{ margin: '16px 0' }}>
                            ...
                            <Breadcrumb.Item>Ajouter un Type</Breadcrumb.Item>
                        </Breadcrumb>
                        <div className="site-layout-background" style={{ padding: 24, minHeight: 360 }}>
                            ...
                            <div className="input-field">
                                    ...
                                    <label for="name" className="" style={{color:"#ad3216"}}>Nom de Type</label>
                                </div>
                                <div className="input-field">
