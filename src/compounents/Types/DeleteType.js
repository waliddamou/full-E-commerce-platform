...
class DeleteType extends Component {
    ...
    onSubmit(e) {
        ...
        axios({
            url: "http://151.80.56.201:5000/Dashboard/DeleteType/" + id,
            method: 'POST',
            data: formData,
            headers: {
            ...
            this.props.history.push('/ManageTypes')
        })
                ...
                <Layout className="site-layout">
                    ...
                    <Content style={{ margin: '0 16px' }}>
                        <Breadcrumb style={{ margin: '16px 0' }}>
                            ...
                            <Breadcrumb.Item>Supprimer le Type</Breadcrumb.Item>
                        </Breadcrumb>
