...
import '../../App.css';
import {PhoneOutlined,MoneyCollectOutlined,StarOutlined, DollarCircleOutlined,MenuOutlined,DeleteOutlined,LogoutOutlined ,ToolOutlined ,ShoppingCartOutlined,UsergroupAddOutlined ,MoreOutlined,ShoppingOutlined , MenuUnfoldOutlined, DashboardOutlined , EditOutlined, ChromeOutlined, PlusCircleOutlined } from '@ant-design/icons';
...
class ManageCategories extends Component {
    ...
    componentDidMount() {
        ...
        .then((findresponse)=>
        {   this.setState({
            Categories : findresponse.Categories.map((row, i) =>
            result.push([row.id, row.Name,row.Mother,<><Button href={"/EditSubCategorie/"+row.id} icon={<EditOutlined />}></Button> <Button href={"/DeleteSubCategory/"+row.id} icon={<DeleteOutlined />}></Button></>])) })   
        } )
                ...
                <Layout className="site-layout">
                    ...
                    <Content style={{ margin: '0 16px' }}>
                        <Breadcrumb style={{ margin: '16px 0' }}>
                            ...
                            <Breadcrumb.Item>Gérer les sous Catégories</Breadcrumb.Item>
                        </Breadcrumb>
                        <div className="site-layout-background" style={{ padding: 24, minHeight: 360 }}>
                        <MUIDataTable
                        title={"Catégories"}
                        columns={["ID", "NOM", "Catégorie Mére","Actions"]}
