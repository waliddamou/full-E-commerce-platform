...
const openNotification = () => {
    ...
    notification.open({
        message: 'Bon travail',
        description:
            'La Sous Catégorie a été ajouté.',
        btn,
        key,
        onClose: close,
    });
...
class AddSubCategorie extends Component {
    constructor() {
        super()
        this.state = {
            name: "",
    ...
    Submit(e){
        ...
        axios({
            url: "http://151.80.56.201:5000/Dashboard/AddSubCategory",
            method: 'POST',
            data: formData,
            headers: {
                ...
                <Layout className="site-layout">
                    ...
                    <Content style={{ margin: '0 16px' }}>
                        <Breadcrumb style={{ margin: '16px 0' }}>
                            ...
                            <Breadcrumb.Item>Ajouter une Sous Catégorie</Breadcrumb.Item>
                        </Breadcrumb>
                            ...
                            <div className="col s12 m6">
                                ...
                                <form noValidate onSubmit={this.Submit}>
                                    <div className="input-field">
                                        ...
                                        <label for="name" className="" style={{ color: "#ad3216" }}>Nom de la sous Catégorie </label>
                                    </div>
                                    <div className="input-field">
