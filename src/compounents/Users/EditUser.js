                ...
                if (!findresponse.status === 200 || findresponse.msg === 'Not enough segments') {
                    ...
                    if (!findresponse.user) {
                        ...
                        if (findresponse.user.role === "Livreur") {
                            ...
                            fetch(`http://151.80.56.201:5000/Dashboard/EditUser/${this.state.id}`, {
                                method: 'get', headers: {
                                    Accept: 'application/json',
                                    'Content-Type': 'application/json',
                                    'Authorization': "Bearer " + token,
                                ...
                                .then((findresponse) => {
                                    this.setState({
                                        first_name: findresponse.User.Name,
                                        last_name: findresponse.User.Lastname,
                                        email: findresponse.User.Email,
                                        phone: findresponse.User.Phone,
                                        birth: findresponse.User.Birth
                                    })
                                })
                        }
                    }
    ...
    render() {
        return (
            <Layout style={{ minHeight: '100vh' }}>
                ...
                <Sider className="Sider" width={260} collapsible collapsible collapsed={this.state.collapsed} onCollapse={()=>this.onCollapse(this.state.collapsed)} style={{ background: '#ad3216' }}>
                ...
                <Layout className="site-layout">
                    ...
                    <Content style={{ margin: '0 16px' }}>
                        <Breadcrumb style={{ margin: '16px 0' }}>
                            ...
                            <Breadcrumb.Item>Modifier un Utilisateurs</Breadcrumb.Item>
                        </Breadcrumb>
