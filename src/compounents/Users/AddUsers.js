...
import '../../App.css';
import {StarOutlined,MoneyCollectOutlined,PhoneOutlined, DollarCircleOutlined,MenuOutlined,LogoutOutlined ,ToolOutlined ,ShoppingCartOutlined,UsergroupAddOutlined ,MoreOutlined,ShoppingOutlined , MenuUnfoldOutlined, DashboardOutlined, EditOutlined, ChromeOutlined, PlusCircleOutlined } from '@ant-design/icons';
...
class AddUsers extends Component {
    ...
    onSubmit(e){
        ...
        axios({
            url: "http://151.80.56.201:5000/AddUser",
            method: 'POST',
            data: formData,
            headers: {
                ...
                <Layout className="site-layout">
                    ...
                    <Content style={{ margin: '0 16px' }}>
                        <Breadcrumb style={{ margin: '16px 0' }}>
                            ...
                            <Breadcrumb.Item>Ajouter un Utilisateurs</Breadcrumb.Item>
                        </Breadcrumb>
                        ...
                        <form noValidate onSubmit={this.onSubmit}>
                                ...
                                <div className="input-field">
                                    ...
                                    <label for="birth" className="" style={{color:"#ad3216"}}>Date de Naissance</label>
                                </div>
                                <div className="input-field">
                                ...
                                <div className="input-field">
                                    ...
                                    <label for="password2" className="" style={{color:"#ad3216"}}>Confirmer le mot de passe</label>
                                </div>
